namespace TAD
{
    ...
    public class GithubTests
    {
        ...
        public void Setup()
        {
            ...
            eyes_ = new Eyes();
            eyes_.ApiKey = Environment.GetEnvironmentVariable("MY_API_KEY");
            eyes_.ForceFullPageScreenshot = true;
            eyes_.Batch = batch_;

            driver_ = eyes_.Open(driver_, "Github", TestContext.CurrentContext.Test.Name,
                new Size(width_, 600));
        }
        ...
        private void ClickNavButton_(By locator)
        {
            var navMenu = driver_.FindElement(By.ClassName("octicon-three-bars"));
            if (navMenu.Displayed)
            {
                navMenu.Click();
            }

            driver_.FindElement(locator).Click();
        }
        ...
        public abstract class BasePage
        {
            ...
            public PersonalPage GoToPersonalPage()
            {
                ...
                //    "document.getElementsByClassName('octicon-mark-github')[0].style.visibility = 'hidden'");
